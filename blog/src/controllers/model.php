...
function getPosts() : array {
    ...
    "SELECT id, title, content, DATE_FORMAT(french_creation_date, '%d/%m/%Y à %Hh%imin%ss') AS french_creation_date
     FROM posts ORDER BY french_creation_date DESC LIMIT 0, 5"
    );
